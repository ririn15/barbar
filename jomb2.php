...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-warning sticky-top">
            <a class="navbar-brand" href="#">jajan online</a></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="jomb2.php">daftar</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="jomb3.php">pesan</a><span class="sr-only">(current)</span></a>
                    </li>                
                </ul>
                ...
                <div class="card ">
                    <div class="card-header">Data pembeli</div>
                         ...
                         <div class="container align-items-center">
                             ...
                             <form action="jomb3.php" method="post">
